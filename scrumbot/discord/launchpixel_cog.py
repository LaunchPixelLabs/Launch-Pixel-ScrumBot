...
class OnboardingView(discord.ui.View):
    ...
    async def on_ready(self):
        ...
        await self.bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="Launch Pixel tickets | !ticket"))
    ...
    async def ticket_create(self, ctx, *, args: str):
    ...
    async def ticket_assign(self, ctx, ticket_id: str, member: discord.Member):
    ...
    async def ticket_status(self, ctx, ticket_id: str, status: str):
    ...
    async def ticket_view(self, ctx, ticket_id: str):
    ...
    async def blocker(self, ctx, *, description: str):
